...
from utils.pytorch import optimizer_cuda, count_parameters, compute_gradient_norm, compute_weight_norm, sync_networks, sync_grads, to_tensor
...
class SACAgent(BaseAgent):
    ...
    def _build_actor(self, actor):
        self._actor = actor(self._config, self._ob_space, self._ac_space, self._config.tanh_policy)
    ...
    def _update_network(self, transitions):
        ...
        with torch.no_grad():
            ...
            target_q_value = rew * self._config.reward_scale + (1 - done) * self._config.discount_factor * q_next_value
