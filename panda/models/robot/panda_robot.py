...
from utils.mjcf_utils import xml_path_completion, array_to_string


class Panda(Robot):
    """Panda is a sensitive single-arm robot designed by Franka."""

    def __init__(self, xml_path="robot/panda/robot_torque.xml"):

        super().__init__(xml_path_completion(xml_path))

        self.bottom_offset = np.array([0, 0, 0]) # ignore the bottom offset; directly define base_xpos in world frame
